  ...
  return (
    <>
      <div id="header">
        ...
        <p>Use OpenAI to search for a session that will be interesting for you. Write the topic you're interested in, and (up to) the top ten most interesting and related session will be given to you. There are {sessionsCount} session indexed so far.</p>
      </div>
      <div>
      { userInfo ?
